...
class ManageRoles extends Component {
    constructor(props) {
        ...
        this.state={
            ...
            permission_list:[
                ...
                {name:'Manage Customer',check:0},
                {name:'Manage Products',check:0},
                {name:'Manage Orders',check:0},
                {name:'Manage Categories',check:0},
                {name:'Manage Distributors',check:0},
                {name:'Manage Permissions',check:0},
    ...
    load_permissions(){
        ...
        Axios.post('/api/get_permissions_by_role_id',senderdata).then(res=>{
            ...
            perms[3].check = per.orders;
            perms[4].check = per.categories;
            perms[5].check = per.distributors;
            perms[6].check = per.permissions;
            perms[7].check = per.reports;
            this.setState({
