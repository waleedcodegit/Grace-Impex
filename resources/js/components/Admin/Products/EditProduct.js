                        ...
                        <div className="row col-md-12">
                            ...
                            <div class="form-group input_div col-md-4">
                                <label className="input_label" for="exampleInputEmail1">Sub Category</label>
                                    <select value={this.state.p_subcat_id || ""} onChange={this.sub_cat_id.bind(this)} type="email" class="form-control " id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Category Name" >
                                    <option value="">Choose..</option>
                                    {
