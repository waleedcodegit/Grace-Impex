                    ...
                    <div className="container-fluid p-3">
                        <div className="wrapper row">
                            ...
                            {/* <h3 className="product-title">{this.state.product.name}</h3> */}
                                ...
                                <h4 className="price mt-4">Rs. <span>{this.state.price}</span></h4>
                                {/* <p className="vote"><strong>91%</strong> of buyers enjoyed this product! <strong>(87 votes)</strong></p> */}
                                <div className="row mt-3">
                                <h5 className="sizes pt-2 ml-3">{this.state.product.varient_type}:
                                </h5>
                                <select style={{height:'33px'}} onChange={this.onchange_varient.bind(this)} value={this.state.varient_id} className="form-control col-md-2 ml-3">
                                ...
                                <div className="row mt-2">
                                    ...
                                    <div className="row ml-3">
                                        <button onClick={this.decrease_qty.bind(this)} className="btn btn-outline-light quantity_btn">-</button>
                                        <input onChange={this.onchange_qty.bind(this)} type="number" value={this.state.qty} className="form-control   quantity_btn col-md-4"/>
                                        <button onClick={this.increase_qty.bind(this)} className="btn btn-outline-light quantity_btn">+</button>
                                    </div>
                                </div>
                        ...
                        <div className="row feature-row mt-4">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-12">
                                <div className="featureValueBox text-center">
                                    <img className="featureIcon " src={img_baseurl+data.image}></img>
